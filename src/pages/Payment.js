        ...
        <header>
          <div className="container text-center">
            ...
            <ol className="breadcrumb breadcrumb-inverted">
              ...
              <li><a className="active" href="/payment">Payment</a></li>
          ...
          <div className="clearfix">
            <div className="row">
              <div className="col-xs-6">
                <a href="/delivery" className="btn btn-clean-dark"><span className="icon icon-chevron-left" /> Back to delivery</a>
              </div>
              <div className="col-xs-6 text-right">
                <a href="/receipt" className="btn btn-main"><span className="icon icon-cart" /> Checkout</a>
              </div>
            </div>
          </div>
          {/* ========================  Payment ======================== */}
